...
const FINDING_TYPE_META: Record<string, { label: string; description: string }> = {
  ...
  COMMAND_INJECTION_CS:  { label: 'Command Injection (C#)', description: 'Process.Start() or ProcessStartInfo called with user-controlled input in C# code, enabling arbitrary command execution.' },
  ...
  SSTI:           { label: 'Server-Side Template Injection', description: 'User-controlled input used directly in a template string rendered server-side, enabling arbitrary code execution via SSTI.' },
...
const FINDING_TO_OWASP: Record<string, { id: string; name: string }> = {
  ...
  COMMAND_INJECTION_CS:  { id: 'A03:2021', name: 'Injection' },
  ...
  SSTI:                  { id: 'A03:2021', name: 'Injection' },
