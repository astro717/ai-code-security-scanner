 ...
 */
export declare function getSnippet(result: ParseResult, line: number): string;
/**
 ...
 */
export declare function walkNode(node: TSESTree.Node, callback: (n: TSESTree.Node) => void): void;
/**
 * Extracts the primitive value from a Literal AST node.
 * Returns undefined for any non-literal node type.
 */
export declare function getLiteralValue(node: TSESTree.Node): string | boolean | null | undefined;
